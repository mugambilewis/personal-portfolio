...
const Connect = () => {
    return (
        ...
        <div className=" text-gray-800 flex flex-col items-center justify-center gap-8 py-6 w-full rounded-lg bg-[#e6f1fe] shadow-[20px_20px_60px_#bebebe,-20px_-20px_60px_#ffffff]" >
            ...
            <button
              className="inline-block px-11 py-4 rounded-[0.375rem] text-[#60a5fa] text-base border-[2px] border-[#60a5fa] cursor-pointer transition duration-300 ease-in-out hover:bg-[#60a5fa] hover:text-white"
