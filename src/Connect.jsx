    ...
    return (
        <div className="bg-white text-gray-800 flex flex-col items-center justify-center gap-4 p-6">
            ...
            <a
              ...
              className="inline-flex justify-center items-center w-12 h-12 bg-transparent border-2 border-[#60a5fa] rounded-full text-[#60a5fa] text-base m-12 mr-6 hover:bg-[#60a5fa] hover:text-white   transition duration-300 ease-in-out hover:scale-[1.3] hover:-translate-y-[5px]"
